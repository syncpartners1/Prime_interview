...
- 30% תיעדוף וניהול עומס: טיפול נכון בדחיפות (P1 לפני P4), סיווג נכון בין Incident, Change Request ו-Service Request, והאם ההחלטה על סטטוס הקריאה (טיפול ישיר / העברה למנהלת התמיכה / העברה למפתח / העברה למחלקה אחרת / סגירה) הייתה מתאימה לתוכן הקריאה - כולל ציון קריאות ספציפיות שנסגרו בטעות או נותבו בצורה לא נכונה. תיעדוף טוב אינו מסתמך רק על תווית P1-P4 פורמלית: תן קרדיט למועמד שמזהה קריאות שחוסמות עמיתים/צוותים שלמים (bottleneck - למשל צוות שממתין לתשובה כדי להמשיך לעבוד) ומטפל בהן מוקדם גם ללא תיוג חירום, ושמשווה דד-ליינים מפורשים המוזכרים בתוכן הקריאות/המיילים (כגון "אני צריך תשובה עד בעוד X דקות") מול הזמן שנותר במבחן. אין סדר תיעדוף "נכון" יחיד - קבל כל סדר טיפול שמלווה בהיגיון עסקי סביר (למשל השוואה נכונה בין שני דד-ליינים קרובים), גם אם אינו זהה לגמרי לפתרון המומלץ.
- 30% התאמת תקשורת למודל DISC: התאמת הטון, האורך והסגנון של התשובות החופשיות לכל אחד מארבעת סוגי השולחים (D, I, S, C). זהה במפורש כל מייל שבו תגובת המועמד לא הייתה מותאמת לסגנון התקשורת של השולח, וציין זאת בפירוט. שים לב במיוחד למקרים בהם המועמד נדרש למסור עדכון על עיכוב/בעיה לגורם בכיר (כגון סמנכ"ל) - תן קרדיט למענה תמציתי ומקצועי שמשדר שליטה במצב (מה קורה, מה עושים, מתי העדכון הבא), ולא רק דיווח יבש על הבעיה.
